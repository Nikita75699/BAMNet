...
\author*[2]{\fnm{Olga M.} \sur{Gerget}}\email{olgagerget@mail.ru}
...
The study used intraoperative fluoroscopic images acquired during TAVI procedures in patients with severe aortic stenosis. The present work builds on a previously published dataset of intraoperative angiographic images \cite{laptev2025_dataset} and extends it with additional patients and revised annotations. The final dataset comprised 2,925 grayscale images of size $1000 \times 1000$ pixels (8-bit) obtained from 83 patients between 2018 and 2024.

...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/figure_1/orig_0019_008_030.png}
        \caption{}
        \label{fig:orig1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/figure_1/sample_0019_008_030.jpeg}
        \caption{}
        \label{fig:annot1}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/figure_1/orig_0019_013_027.png}
        \caption{}
        \label{fig:orig2}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/figure_1/sample_0019_013_027.jpeg}
        \caption{}
        \label{fig:annot2}
    \end{subfigure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../figures/figure_2/BAMNet.png}
...
\centering
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/figure_3/orig_0019_008_030_implant_zone.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/figure_3/orig_0019_013_027_implant_zone.png}
        \caption{}
    \end{subfigure}
...
The third clinical implication concerns radiation burden. If the model reduces the need for additional angiographic runs, it may also reduce cumulative exposure for both the patient and the operating staff. Although radiation dose was not measured directly here, the task formulation is aligned with the \textcolor{red}{``as low as reasonably achievable''} principle and with the broader objective of safer intraoperative guidance.
...
\item \textbf{Models:} \url{https://doi.org/10.5281/zenodo.19295876}
\end{itemize}

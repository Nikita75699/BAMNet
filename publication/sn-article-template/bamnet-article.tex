...
\textbf{Methods} A retrospective dataset of 2,925 fully anonymized fluoroscopic frames from 83 patients who underwent TAVI between 2018 and 2024 was used. Expert annotations included binary masks of the contrast-enhanced aortic root and four anatomical landmarks: AA1, AA2, STJ1, and STJ2. We developed BoundaryAwareMAnet (BAMNet), a multitask architecture combining an EfficientNet-V2 encoder, a MA-Net-inspired decoder, a coordinate-aware landmark head, and an auxiliary boundary-guidance pathway. Model performance was evaluated using patient-level five-fold cross-validation. Segmentation quality was assessed with Dice, intersection-over-union (IoU), and Surface Dice at 4 mm, while landmark localization was evaluated using median and mean point localization error.

\textbf{Results} Across five folds, BAMNet achieved a Dice score of $0.92 \pm 0.01$, an IoU of $0.85 \pm 0.02$, and a Surface Dice@4 mm of $0.84 \pm 0.03$. Landmark localization performance reached a median error of $7.64 \pm 0.33$~px and a mean error of $10.02 \pm 0.17$~px. The model produced both segmentation masks and landmark coordinates in a single forward pass and maintained real-time inference performance of 62.5 FPS.
...
Numerical ablation results are summarized in Table~\ref{tab:ablation_results}. The variant with a fixed soft-argmax temperature of 8 achieved the highest Dice, IoU, and Surface Dice@4~mm, indicating particularly strong segmentation performance. However, the full BAMNet v4 configuration yielded the lowest mean and median landmark localization errors together with the best PCK@10, and therefore provided the most balanced combination of segmentation quality and landmark localization accuracy.
